...
//Current date. Replace 3v battery (reset RTC) every time this is updated and flashed
const uint32_t CURR_DATE_EPOCH = 1637750017;

//Testing
//const uint32_t START_DATE_EPOCH = 1637749313;
//const uint32_t CURR_DATE_EPOCH = 1637749313;
...
void setup() {
  ...
  */
  ...
  /*
  //Button pressed to load eeprom (Active low)
  if(!digitalRead(4)) {
    last_elapsed_epoch = eeprom_read32(EEPROM_ADDR);
  }
  else {
    last_elapsed_epoch = 0;
  }
